...
/**
 * App Modal Design System (role-agnostic)
 * Generalization of the registrar modal language — border-2 tinted cards,
 * rounded-xl/2xl, generous responsive padding, no horizontal scroll,
 * theme-color tints. Admin and registrar portals share this implementation.
 *
 * `registrar-modal` re-exports this module for backwards compatibility.
 */
...
/** Backwards-compatible alias for the registrar portal. */
export const RegistrarModal = AppModal;
export type RegistrarModalProps = AppModalProps;
